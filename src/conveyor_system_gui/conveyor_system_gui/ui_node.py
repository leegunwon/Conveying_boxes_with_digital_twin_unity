...
class MyApp(QWidget):
    ...
    def init_ui(self):
        ...
        self.stop_button.setStyleSheet("background-color: #f44336; color: white; border-radius: 5px; font-size: 14px; padding: 10px;")
        self.stop_button.clicked.connect(self.conv_publishing)
    ...
    def conv_publishing(self):
        data = {
            "control": "go",
            "distance.mm": f"{int(int(100) * 10.5)}\\n"
        }
        msg = json.dumps(data)
